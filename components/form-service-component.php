<div class="w-full min-w-80 bg-white mb-20 px-5 pt-20 sm:mb-20 sm:pr-14 sm:pl-10 lg:pr-24 lg:pl-20 lg:pt-32 lg:mb-[17rem] xl:mb-40">
    <div class="w-full flex flex-wrap">
        <div class="w-full mb-4 sm:mb-0 md:w-5/12">
            <img src="images/form-service-image.png" alt="BYD HAKA AUTO booking service" class="w-full rounded-lg object-cover object-center" />
        </div>
...
<script>
    ...
    function submmitBookingService(event) {
        ...
        if (!firstName.value || !lastName.value || !isValidEmail || !isValidPhone || !model.value || !branch.value || formatDateYYYYMMDD(date.value).includes('NaN') || !time.value || !problem.value || !terms.checked) {
            ...
            const url = `${BASE_URL}/booking-service`
            const formData = {
