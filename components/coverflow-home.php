<div class="w-full py-12 px-2 z-0 relative sm:px-0" style="background: rgba(230, 230, 255, 1);">
    <div class="w-full coverflow-container">
        <div class="coverflow" id="coverflow">
            <div class="image-wrapper">
                <img src="images/coverflow/img1_.png" alt="BYD HAKA Greater Performance" id="coverflow-image" class="rounded-lg shadow-lg" data-video-url="https://www.youtube.com/embed/JyGROfuXggk">
                <svg class="play-icon" viewBox="0 0 24 24" fill="white">
                    <path d="M8 5v14l11-7z" />
                </svg>
            </div>
            <div class="image-wrapper">
                <img src="images/coverflow/img2_.png" alt="BYD HAKA Greater Performance" id="coverflow-image" class="rounded-lg shadow-lg" data-video-url="https://www.youtube.com/embed/50PU-cQx7j0">
                <svg class="play-icon" viewBox="0 0 24 24" fill="white">
                    <path d="M8 5v14l11-7z" />
                </svg>
            </div>
            <div class="image-wrapper">
                <img src="images/coverflow/img3_.png" alt="BYD HAKA Greater Performance" id="coverflow-image" class="rounded-lg shadow-lg" data-video-url="https://www.youtube.com/embed/fl7hQ6-2Bjc">
                <svg class="play-icon" viewBox="0 0 24 24" fill="white">
                    <path d="M8 5v14l11-7z" />
                </svg>
            </div>
    ...
    <div class="arrow-button-coverflow left z-10" onclick="prevCoverflow()">
        <span class="arrow">&#10094;</span>
    </div>
    <div class="arrow-button-coverflow right z-10" onclick="nextCoverflow()">
        <span class="arrow">&#10095;</span>
    </div>
